...
import os
try:
	os.chdir(os.path.join(os.getcwd(), '../../../var/folders/cv/h3pf8jjj14lb4wmbm62112400000gn/T'))
	print(os.getcwd())
except:
	pass
#%% [markdown]
...
for feature in Features:
    ...
    head = headTitle.find("a",href=True).text
    teaser = feature.find("div",attrs={"class":"rollover_description_inner"}).text
...
#%%
# Function to gather all scraped data and save in dictionary
def scrape(x):
    Head = head.lstrip
    Teaser = teaser.lstrip
    return {
        "Head":head,"Teaser":teaser,
